...
async function GET(request) {
    try {
        ...
        // In production: Fetch real notifications from database
        // const notifications = await db.notifications.findByUserId(userId)
        // For new users, return empty array (no notifications)
        const notifications = [];
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            notifications
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__47ec247e._.js.map