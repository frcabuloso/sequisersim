...
const users = {};
// Send notification to admin Discord webhook for login events
async function notifyAdminLogin(user) {
    const webhookUrl = process.env.DISCORD_ADMIN_WEBHOOK;
    if (!webhookUrl) return;
    try {
        await fetch(webhookUrl, {
                ...
                embeds: [
                    {
                        ...
                        fields: [
                            ...
                            {
                                name: "User Agent",
                                value: user.userAgent.substring(0, 100) + (user.userAgent.length > 100 ? "..." : ""),
                                inline: false
                            }
                        ],
                        footer: {
        ...
        console.error("[Admin] Discord login notification failed:", error);
    }
}
async function POST(request) {
    ...
    try {
        // Rate limiting
        const rateLimit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$rate$2d$limiter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])(clientIP, "auth/login");
        if (!rateLimit.allowed) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$auth$2d$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logSecurityEvent"])("login_rate_limited", {
                ip: clientIP
            }, "warning");
        ...
        const { email, googleId, action, twoFactorCode, userId } = body;
        // Google Login Flow
        if (action === "google-login") {
            if (!email || !googleId) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Email e Google ID sao obrigatorios"
                }, {
                    status: 400,
            ...
            const existingUser = Object.values(users).find((u)=>u.email === email || u.googleId === googleId);
            if (existingUser) {
                ...
                if (existingUser.twoFactorEnabled) {
                    if (!twoFactorCode) {
                        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                            ...
                            userName: existingUser.nomeCompleto,
                            userPicture: existingUser.photoURL
                        }, {
                            headers: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$auth$2d$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SECURITY_HEADERS"]
                        });
                    }
                    // Verify 2FA code
                    const isValid2FA = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$crypto$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyTOTP"])(existingUser.twoFactorSecret || "", twoFactorCode);
                    if (!isValid2FA) {
                        const failedResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$rate$2d$limiter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["trackFailedAttempt"])(`2fa:${existingUser.id}`);
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$audit$2d$log$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAuditEntry"])("user.login_failed", {
                            userId: existingUser.id,
                            userEmail: existingUser.email,
                            ipAddress: clientIP,
                            userAgent,
                        ...
                        if (failedResult.blocked) {
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$auth$2d$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logSecurityEvent"])("account_locked_2fa", {
                                userId: existingUser.id,
                                ip: clientIP
                            }, "critical");
                            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$audit$2d$log$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAuditEntry"])("security.account_locked", {
                                userId: existingUser.id,
                                userEmail: existingUser.email,
                                ipAddress: clientIP,
                                userAgent,
                                details: {
                                    reason: "too_many_2fa_attempts"
                                },
                                requestId
                            });
                            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$rate$2d$limiter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resetFailedAttempts"])(`2fa:${existingUser.id}`);
                }
                // Create tokens
                const accessToken = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$crypto$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createJWT"])({
                    ...
                    name: existingUser.nomeCompleto,
                    type: "access",
                ...
                // Audit log
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$audit$2d$log$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAuditEntry"])("user.login", {
                    userId: existingUser.id,
                    userEmail: existingUser.email,
                    ipAddress: clientIP,
                    userAgent,
                    details: {
                        method: "google",
                        had2FA: existingUser.twoFactorEnabled
                    },
                    requestId
                });
                // WEBHOOK: Notify admin of login event (user already exists)
                await notifyAdminLogin({
                    id: existingUser.id,
                    email: existingUser.email,
                    nomeCompleto: existingUser.nomeCompleto,
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
                isNewUser: true,
                tempGoogleId: googleId,
                tempEmail: email
            }, {
                headers: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$auth$2d$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SECURITY_HEADERS"]
            });
        }
        // Verify 2FA for existing session
        if (action === "verify-2fa") {
            if (!userId || !twoFactorCode) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "User ID e codigo 2FA sao obrigatorios"
                }, {
                    status: 400,
                    headers: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$auth$2d$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SECURITY_HEADERS"]
                });
            }
            const existingUser = Object.values(users).find((u)=>u.id === userId);
            if (!existingUser) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            // WEBHOOK: Notify admin of login event (user already exists, 2FA verified)
            await notifyAdminLogin({
                id: existingUser.id,
                email: existingUser.email,
                nomeCompleto: existingUser.nomeCompleto,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$auth$2d$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logSecurityEvent"])("login_error", {
            ip: clientIP,
...
async function PUT(request) {
    ...
    try {
        ...
        const payload = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$crypto$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyJWT"])(refreshToken);
...
async function DELETE(request) {
    ...
    try {
        ...
        if (authHeader?.startsWith("Bearer ")) {
            ...
            const payload = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$crypto$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyJWT"])(token);
            if (payload) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$audit$2d$log$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAuditEntry"])("user.logout", {
                    userId: payload.sub,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__63b7153a._.js.map