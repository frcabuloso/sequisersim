...
async function GET(request) {
    try {
        ...
        // const pendingDeposits = await db.deposits.findPendingByUserId(userId)
        // For now return default/empty data for new users
        // New users should have zero balance and no history
        const dashboardData = {
            saldo: 0,
            emProcessamento: 0,
        ...
        // In production, calculate from real transactions:
        // - saldo: user.balance
        // - emProcessamento: sum of pending deposits
        // - depositosPendentes: count of pending deposits
        // - totalEntradas: sum of all deposits
        // - totalSaidas: sum of all transfers
        // - chartData: calculate from transaction history
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aade97c8._.js.map